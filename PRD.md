...
- `GET /:projectId` - List project tasks (secured, role-based) #!!!!!!!!!!!!!!!!!!Done
- `POST /:projectId` - Create task (secured, Admin/Project Admin) #!!!!!!!!!!!!!!!!!!!!!!!Done
- `GET /:projectId/t/:taskId` - Get task details (secured, role-based) #!!!!!!!!!!!!!!!!!!Done
- `PUT /:projectId/t/:taskId` - Update task (secured, Admin/Project Admin) #!!!!!!!!!!!!!!Done
- `DELETE /:projectId/t/:taskId` - Delete task (secured, Admin/Project Admin) #!!!!!!!!!!Done
